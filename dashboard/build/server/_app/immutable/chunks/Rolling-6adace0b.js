import { c as create_ssr_component, e as escape } from "./index-80a2f878.js";
/* empty css                                                */const css = {
...
const Rolling = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  $$result.css.add(css);
  return `<div class="${"spinner-rolling svelte-1852m2u"}" style="${"--scale-factor: " + escape(scaleFactor, true) + "; " + escape(style, true)}"><div class="${"spinner-rolling-2 svelte-1852m2u"}" style="${"--clr: " + escape(color, true) + ";"}"><div class="${"svelte-1852m2u"}"></div></div>
</div>`;
});
export {
  Rolling as R
