...
import { R as Rolling } from "../../_app/immutable/chunks/Rolling-6adace0b.js";
...
const _layout = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `${$$result.head += `${$$result.title = `<title>Fuxelbau Modmail ${escape(((_a = $page.url) == null ? void 0 : _a.pathname.split("/")[1]) ? `| ${$page.url.pathname.split("/")[1][0].toUpperCase()}${$page.url.pathname.split("/")[1].slice(1)}` : "")}</title>`, ""}`, ""}
