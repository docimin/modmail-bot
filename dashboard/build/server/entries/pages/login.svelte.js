import { c as create_ssr_component, h as createEventDispatcher, e as escape, i as null_to_empty, d as add_attribute, v as validate_component } from "../../chunks/index-aa015feb.js";
/* empty css                                                           */var Default_svelte_svelte_type_style_lang = "";
const css$1 = {
...
const Default = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<button class="${escape(null_to_empty(disabled ? "disabled" : "not-disabled")) + " svelte-tkjn45"}"${add_attribute("style", style, 0)}>${slots.default ? slots.default({}) : `
  Button
 `}
</button>`;
});
...
<div class="${"container svelte-b5o5q1"}"><h1 class="${"svelte-b5o5q1"}">fyfu modmail</h1>
 ${validate_component(Default, "DefaultButton").$$render($$result, {
